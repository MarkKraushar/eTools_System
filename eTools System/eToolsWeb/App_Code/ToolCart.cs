...
public class ToolCart
{
	public static List<ToolCartData> RetrieveCart()
	{
        ...
        if (ToolCart.CookieExist())
        {
            try
            {
                string XMLCartString = HttpContext.Current.Request.Cookies["ToolCart"].Value;
    ...
    public static void SaveCart(List<ToolCartData> theCart)
    {
        ...
        HttpContext.Current.Response.Cookies.Add(new HttpCookie("ToolCart", XMLCompressedCart.ToString()));
    }
    ...
    {
        HttpCookie aCookie = new HttpCookie("ToolCart");
    ...
    {
        return (HttpContext.Current.Request.Cookies["ToolCart"] != null);
    }
